  ...
  setup() {
    return () => (
      <div class="w-full px-6">
        <div class="container relative flex flex-col items-center pt-12 pb-24 mx-auto mt-8 rounded-lg bg-gradient-to-r from-purple-900 via-indigo-700 to-purple-500 sm:pt-24 sm:pb-32 md:pb-48 lg:pb-56 xl:pb-64">
          <svg
            class="absolute top-0 right-0 mt-2 mr-2 lg:mr-12 lg:mt-12"
            width="104px"
            height="95px"
            viewBox="0 0 104 95"
          >
              ...
              <g transform="translate(-1139.000000, -175.000000)" fill="#FFFFFF">
                <g id="Group-5" transform="translate(1139.000000, 175.000000)">
                  ...
                  <path
                    ...
                    id="Fill-81"
                  ></path>
                  <polyline id="Fill-82" points="75 87 13 26"></polyline>
                </g>
              </g>
            </g>
          </svg>
          <svg
            class="absolute bottom-0 left-0 mb-2 ml-2 lg:ml-12 lg:mb-12"
            width="104px"
            height="95px"
            viewBox="0 0 104 95"
          >
          ...
          <div class="w-11/12 mb-5 sm:w-2/3 sm:mb-10">
            <h1
              data-scroll
              data-scroll-speed="2"
              class="pt-20 text-2xl font-bold leading-tight text-center text-white sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl"
            >
              Create beautiful, accessible and responsive UI's faster
            </h1>
          </div>
          <div data-scroll data-scroll-speed="2" class="flex items-center justify-center mb-10 sm:mb-20">
            <button class="px-4 py-1 text-sm text-indigo-700 transition duration-150 ease-in-out bg-white rounded focus:outline-none hover:bg-gray-100 sm:px-8 sm:py-3">
              Get Started
            </button>
            <button class="px-4 py-1 ml-3 text-sm text-white transition duration-150 ease-in-out bg-transparent border border-white rounded sm:ml-6 focus:outline-none hover:bg-purple-800 sm:px-8 sm:py-3">
              Learn More
            </button>
          </div>
        </div>
        <div class="container flex justify-center mx-auto -mt-20 md:-mt-56 sm:-mt-40">
          <div data-scroll data-scroll-speed={-1} class="relative w-11/12 sm:w-2/3">
            <img src="/images/dashboard.png" alt="" class="relative" />
          </div>
        </div>
      </div>
    );
