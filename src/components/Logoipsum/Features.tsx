...
export default defineComponent({
  setup() {
    return () => (
      <section class="container pt-16 mx-auto bg-white max-w-8xl">
        <div>
          <div class="flex flex-col items-center px-4">
            <p data-scroll class="text-lg leading-normal text-center text-gray-600 uppercase">
              in few easy steps
            </p>
            <h2 class="pt-4 text-4xl font-extrabold leading-tight text-center text-gray-800 lg:text-5xl lg:w-7/12 md:w-9/12">
              Create Beautiful Landing Pages & Web Apps in a Jiffy
            </h2>
          </div>
          <div class="flex flex-wrap justify-between px-4 mt-20">
            <div class="flex pb-20 sm:w-full md:w-5/12">
              <div class="relative w-20 h-20 mr-5">
                <div class="absolute top-0 right-0 w-16 h-16 mt-2 mr-1 bg-indigo-100 rounded"></div>
                <div class="absolute bottom-0 left-0 flex items-center justify-center w-16 h-16 mt-2 mr-3 text-white bg-indigo-700 rounded">
                  <svg
              ...
              <div class="w-10/12">
                ...
                <p class="pt-2 text-base leading-normal text-gray-600">
