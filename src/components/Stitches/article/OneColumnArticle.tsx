...
export default defineComponent({
  setup() {
    return () => (
      <section class="container flex flex-col max-w-4xl px-6 py-8 m-auto font-sans text-center">
        <label class="text-sm uppercase">20 Month 2019</label>
        <h1 class="max-w-full m-auto my-8 text-3xl font-medium md:text-4xl lg:text-5xl">
          Lorem Ipsum is simply dummy text of the printing
        </h1>
        <p class="max-w-full m-auto mt-1 mb-6 leading-loose text-left lg:mt-4">
        ...
        <p class="max-w-full m-auto mb-6 leading-loose text-left">
